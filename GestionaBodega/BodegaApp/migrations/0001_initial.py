    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_banco', models.ForeignKey(blank=True, db_column='id_banco', null=True, on_delete=django.db.models.deletion.SET_NULL, to='BodegaApp.banco')),
                ('id_tipo_pago', models.ForeignKey(blank=True, db_column='id_tipo_pago', null=True, on_delete=django.db.models.deletion.SET_NULL, to='BodegaApp.tipopago')),
            ],
            options={
                'db_table': 'pago',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pago_id_pago', models.OneToOneField(blank=True, db_column='pago_id_pago', null=True, on_delete=django.db.models.deletion.SET_NULL, primary_key=True, serialize=False, to='BodegaApp.pago')),
                ('venta_id_venta', models.ForeignKey(blank=True, db_column='venta_id_venta', null=True, on_delete=django.db.models.deletion.SET_NULL, to='BodegaApp.venta')),
            ],
            options={
