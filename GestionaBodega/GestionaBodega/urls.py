...
urlpatterns = [
    ...
    path('webpaysuccess/', webpay_success, name='webpay_success'),
    ...
    path('modificarBodega/',modBodega,name='MODBODEGA'),
    path('modificarAreaBodega/',modAreaBodega,name='MODAREABODEGA'),
